...
const NAV_ITEMS: Record<Role, NavItem[]> = {
  super_admin: [
    ...
    { label: 'Candidatos', href: '/admin/candidatos', icon: <UserSearch className="w-5 h-5" /> },
  ...
  colaborador: [
    { label: 'Meu Painel', href: '/gestor/dashboard', icon: <LayoutDashboard className="w-5 h-5" /> },
    { label: 'Meus Testes', href: '/gestor/testes', icon: <ClipboardList className="w-5 h-5" /> },
    { label: 'Meus Feedbacks', href: '/gestor/feedbacks', icon: <MessageSquare className="w-5 h-5" /> },
  ],
  candidato: [
